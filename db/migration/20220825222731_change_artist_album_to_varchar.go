...
func init() {
	goose.AddMigration(Up20220825222731, Down20220825222731)
}

func Up20220825222731(tx *sql.Tx) error {
	_, err := tx.Exec(`
	...
	INSERT INTO album_tmp (id, name, artist_id, cover_art_path, cover_art_id, artist, album_artist, min_year, max_year, compilation, song_count, duration, genre, created_at, updated_at, full_text, album_artist_id, order_album_name, order_album_artist_name, sort_album_name, sort_artist_name, sort_album_artist_name, size, mbz_album_id, mbz_album_artist_id, mbz_album_type, mbz_album_comment, catalog_num, comment, all_artist_ids) SELECT id, name, artist_id, cover_art_path, cover_art_id, artist, album_artist, min_year, max_year, compilation, song_count, duration, genre, created_at, updated_at, full_text, album_artist_id, order_album_name, order_album_artist_name, sort_album_name, sort_artist_name, sort_album_artist_name, size, mbz_album_id, mbz_album_artist_id, mbz_album_type, mbz_album_comment, catalog_num, comment, all_artist_ids FROM album;
...
func Down20220825222731(tx *sql.Tx) error {
	return nil
}
